				...
				const char* szWinnerMembers, const char* szLoserMembers)
{
	...
	strcpy_s(m_szWinnerClanName, szWinnerClanName);
	strcpy_s(m_szLoserClanName, szLoserClanName);
	strcpy_s(m_szWinnerMembers, szWinnerMembers);
	strcpy_s(m_szLoserMembers, szLoserMembers);

...
{
#ifdef _DISABLE_NETWORK_SECURITY_CHECKS
	return false;
#else
	bool bResult = false;
	int nIPCount = 0;
...
/*		case RCP_IO_DISCONNECT:
		...
		case RCP_IO_WRITE:	// Thread unsafe : ?????? ????? session delete ???
			{

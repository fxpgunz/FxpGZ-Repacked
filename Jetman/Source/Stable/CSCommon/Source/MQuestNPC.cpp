...
bool MQuestNPCCatalogue::ReadXml(const char* szFileName, MZFileSystem* pFileSystem)
{
...
bool MQuestNPCSetCatalogue::ReadXml(const char* szFileName, MZFileSystem* pFileSystem)
{

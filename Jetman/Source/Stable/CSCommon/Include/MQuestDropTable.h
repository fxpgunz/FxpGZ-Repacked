...
public:
	...
	void SetName(const char* szName) { strcpy_s(m_szName,sizeof(m_szName),szName); }	///< 이름 설정
	/// 드롭되는 아이템 추가
...
{
private:
	void ParseDropSet(rapidxml::xml_node<>* element);
...
public:
	...
	bool ReadXml(const char* szFileName, MZFileSystem* pFileSystem = nullptr);		///< xml에서 정보를 읽는다. 

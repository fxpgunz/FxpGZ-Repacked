...
private:
	...
	static void ParseNeedExpLM(rapidxml::xml_node<>* element);
	static void ParseGettingExpLM(rapidxml::xml_node<>* element);
	static void ParseGettingBountyLM(rapidxml::xml_node<>* element);

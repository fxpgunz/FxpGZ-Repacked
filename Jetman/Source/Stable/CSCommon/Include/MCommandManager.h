...
typedef map<unsigned short, MCommandDesc*>	MCommandDescMap;	///< Command Description Map
...
public:
	...
	MCommandDesc* GetCommandDescByID(unsigned short nID);
...
#if defined (_DEBUG) || defined (_PACKET_ALIAS)

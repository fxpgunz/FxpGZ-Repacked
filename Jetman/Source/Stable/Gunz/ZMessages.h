...
#define MSG_JOINED_STAGE						9401		///< You have $ 1 ' entry ' room.
#define MSG_JOINED_STAGE2						9402		///< ' $ 1 ', ' $ 2 ' position of the Nations like an understatement.
#define MSG_JOINED_STAGE_OPTIONS				9403		///< Stage options enabled:
...
#define MSG_SPY_TIME_ALMOST_UP					20014// 교성이가 추가함. cserror에 있던것을 이곳으로 옮김 2005.01.12

...
public:
	...
	bool ParseGameTypeList( int nGameTypeNum, rapidxml::xml_node<>* element);
...
private :
	bool ParseRound( ZGameTypeConfig* pConfig, rapidxml::xml_node<>* element);
	bool ParseLimitTime( ZGameTypeConfig* pConfig, rapidxml::xml_node<>* element);
	bool ParseMaxPlayers( ZGameTypeConfig* pConfig, rapidxml::xml_node<>* element);
};

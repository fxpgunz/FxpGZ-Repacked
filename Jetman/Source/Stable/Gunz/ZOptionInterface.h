...
public:
	...
	void SetOldScreenWidth(int width) { mOldScreenWidth = width; }
	void SetOldScreenHeight(int height) { mOldScreenHeight = height; }
};
...
DECLARE_LISTENER(ZGetSongPositionListener)
...
DECLARE_LISTENER(ZGetCustomMusicListListener)
DECLARE_LISTENER(ZGetEnableCustomMusicListener)
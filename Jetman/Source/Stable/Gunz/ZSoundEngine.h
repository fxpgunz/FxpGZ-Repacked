...
constexpr const char* VOICE_COOL = "nar/NAR01";	// 0.7  추가 완료
constexpr const char* VOICE_NICE = "nar/NAR02";	// 1.0  추가 완료
constexpr const char* VOICE_GREAT = "nar/NAR03";		// 0.8  추가 완료
constexpr const char* VOICE_WONDERFUL = "nar/NAR04";		// 1.2  추가 완료
constexpr const char* VOICE_KILLEDALL = "nar/NAR05";	// 2.0  추가 완료
constexpr const char* VOICE_HEADSHOT = "nar/NAR06";	// 0.7  추가 완료
constexpr const char* VOICE_FANTASTIC = "nar/NAR07";	// 1.5  추가 완료
constexpr const char* VOICE_EXCELLENT = "nar/NAR08";	// 1.0  추가 완료
constexpr const char* VOICE_UNBELIEVABLE = "nar/NAR09";	// 1.3  추가 완료
constexpr const char* VOICE_GET_READY = "nar/NAR10";	// 1.3  추가 완료
constexpr const char* VOICE_LETS_ROCK = "nar/NAR11";	// 1.1  추가 완료
constexpr const char* VOICE_FINAL_ROUND = "nar/NAR27";	// 1.2  추가 완료
constexpr const char* VOICE_YOU_WON = "nar/NAR12";		// 1.0  추가 완료
constexpr const char* VOICE_YOU_LOSE = "nar/NAR13";	// 1.3  추가 완료
constexpr const char* VOICE_RED_TEAM_WON = "nar/NAR14";	// 1.4  추가 완료
constexpr const char* VOICE_BLUE_TEAM_WON = "nar/NAR15";	// 1.4  추가 완료
constexpr const char* VOICE_DRAW_GAME = "nar/NAR16";	// 1.2  추가 완료
constexpr const char* VOICE_REDTEAM_BOSS_DOWN = "nar/NAR19";	// 2.0  추가 완료
constexpr const char* VOICE_BLUETEAM_BOSS_DOWN = "nar/NAR20";		// 2.1  추가 완료
constexpr const char* VOICE_PLAYER_NOT_READY = "nar/NAR26";	// 1.5  추가 완료
constexpr const char* VOICE_BERSERKER_DOWN = "nar/NAR28";		// 1.3  추가 완료
constexpr const char* VOICE_GOT_BERSERKER = "nar/NAR29";	// 1.6  추가 완료
constexpr const char* VOICE_QUEST_START_FAIL = "nar/NAR22";	// 2.8  추가 완료

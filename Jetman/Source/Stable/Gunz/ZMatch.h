...
public:
	...
	inline bool IsRuleClassic();
	inline bool isSpecialTeamsGame();
...
inline bool ZMatch::IsRuleClassic()
{
...
{
	return ((GetMatchType() == MMATCH_GAMETYPE_INFECTION) ||
		(GetMatchType() == MMATCH_GAMETYPE_SPYMODE));
}

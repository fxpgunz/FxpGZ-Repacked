...
void ZGameClient::RequestCreateClan(char* szClanName, char** ppMemberCharNames)
{
	...
	ZPostRequestCreateClan(GetPlayerUID(), m_nRequestID, szClanName, ppMemberCharNames, 0);
	ZPostRequestAgreedCreateClan(GetPlayerUID(), szClanName, ppMemberCharNames, 0);

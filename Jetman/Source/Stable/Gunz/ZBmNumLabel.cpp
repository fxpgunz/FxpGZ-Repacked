...
{
	// The height is originally 32. Set the ratio according to resolution
	//value originally 32, test to ensure no bugs?
	float fRatio = (float)m_Rect.h / (float)m_CharSize.h;

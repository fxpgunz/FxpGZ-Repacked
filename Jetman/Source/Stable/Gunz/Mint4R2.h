...
protected:
	LPDIRECT3DDEVICE9	m_pLPDIRECT3DDEVICE9;
public:
	MDrawContextR2(LPDIRECT3DDEVICE9 pLPDIRECT3DDEVICE9);
...
public:
	LPDIRECT3DDEVICE9		m_pLPDIRECT3DDEVICE9;		// Local Copy
...
public:
	...
	virtual bool Create(const char* szAliasName, LPDIRECT3DDEVICE9 pLPDIRECT3DDEVICE9, const char* szFileName,bool bUseFileSystem=true,DWORD colorkey=0);
//	virtual bool Create(const char* szAliasName, LPDIRECT3DDEVICE9 pLPDIRECT3DDEVICE9, void* pData, int nSize);

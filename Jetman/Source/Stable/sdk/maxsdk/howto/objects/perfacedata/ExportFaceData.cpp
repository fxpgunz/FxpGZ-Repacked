...
class FaceDataExport : public SceneExport {
	static HWND hParams;
	MaxSDK::Util::TextFile::Writer fileStream;
	bool exportSelected;
public:
	FaceDataExport() : exportSelected(false) { }
...
INT_PTR CALLBACK FaceDataExportOptionsDlgProc(HWND hWnd,UINT message,WPARAM wParam,LPARAM lParam) {

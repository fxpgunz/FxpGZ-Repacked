...
public:
   ...
   ChannelMask ChannelsChanged() {return SELECT_CHANNEL|TOPO_CHANNEL;}
...
void EditFaceDataMod::NotifyInputChanged(const Interval& changeInt, PartID partID, RefMessage message, ModContext *mc) {
...
//! [Interface.GetModContexts Example]

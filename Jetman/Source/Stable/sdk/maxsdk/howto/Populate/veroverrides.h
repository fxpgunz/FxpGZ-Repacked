...
#define MAXVER_INTERNALNAME "PopulateExample\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "PopulateExample.dlu\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "3dsmax Populate example (plugin)\0"//should  be overidden on a per-dll level

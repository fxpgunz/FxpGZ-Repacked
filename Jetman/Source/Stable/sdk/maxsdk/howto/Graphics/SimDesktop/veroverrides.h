...
#define MAXVER_INTERNALNAME "SimDesktop\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "SimDesktop.dlu\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Viewport Overlay Fragment (Autodesk)\0"//should  be overidden on a per-dll level

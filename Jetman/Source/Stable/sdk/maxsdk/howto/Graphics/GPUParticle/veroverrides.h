...
#define MAXVER_INTERNALNAME "GPUParticle\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "GPUParticle.dlo\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "ICustomRenderItem sample\0"//should  be overidden on a per-dll level

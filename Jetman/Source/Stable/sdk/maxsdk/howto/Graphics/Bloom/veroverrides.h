...
#define MAXVER_INTERNALNAME "Bloom\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "Bloom.dlu\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Viewport Bloom Fragment (Autodesk)\0"//should  be overidden on a per-dll level

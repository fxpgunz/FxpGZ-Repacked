...
namespace MaxSDK { namespace Graphics {
	...
	UINT GetShaderID_GuassianBlurH()
	{
		if (isDX11())
		{
			return IDR_FX_DX11_GAUSSIANBLURH;
		}
		else
		{
			return IDR_FX_DX9_GAUSSIANBLURH;
		}
	}

	UINT GetShaderID_GuassianBlurV()
	{
		if (isDX11())
		{
			return IDR_FX_DX11_GAUSSIANBLURV;
		}
		else
		{
			return IDR_FX_DX9_GAUSSIANBLURV;
		}
	}
	...
	UINT GetShaderID_AddDraw()
	{
		if (isDX11())
		{
			return IDR_FX_DX11_ADDDRAW;
		}
		else
		{
			return IDR_FX_DX9_ADDDRAW;
		}
	}

	UINT GetShaderID_FilterDraw()
	{
		if (isDX11())
		{
			return IDR_FX_DX11_FILTERDRAW;
		}
		else
		{
			return IDR_FX_DX9_FILTERDRAW;
		}
	}
	...
	HLSLMaterialHandle CreateMaterial_GuassianBlurH()
	{
		...
		loadShader(hMaterial, GetShaderID_GuassianBlurH());
		return hMaterial;
	}
	...
	{
		HLSLMaterialHandle hMaterial;
		loadShader(hMaterial, GetShaderID_GuassianBlurV());
		return hMaterial;
	}
	...
	{
		HLSLMaterialHandle hMaterial;
		loadShader(hMaterial, GetShaderID_AddDraw());
		return hMaterial;
	}
	...
	{
		HLSLMaterialHandle hMaterial;
		loadShader(hMaterial, GetShaderID_FilterDraw());
		return hMaterial;
	}
	...
	DrawQuadWorld CreateRenderWorld()
	{
		...
		HLSLMaterialHandle hMaterial;
		RenderNodeHandle hNode = CreateRenderNode(hMaterial);
		if (hNode.IsValid())
		{
		...
		drawQuadWorld.hGuassianBlurH = CreateMaterial_GuassianBlurH();
		drawQuadWorld.hGuassianBlurV = CreateMaterial_GuassianBlurV();
		drawQuadWorld.hDraw = CreateMaterial_Draw();
		drawQuadWorld.hAddDraw = CreateMaterial_AddDraw();
		drawQuadWorld.hFilterDraw = CreateMaterial_FilterDraw();

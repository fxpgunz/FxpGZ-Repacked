...
#define MAXVER_INTERNALNAME "PrimitiveRenderer\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "PrimitiveRenderer.dlo\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "PrimitiveRenderer Object Implementation\0"//should  be overidden on a per-dll level

...
#define MAXVER_INTERNALNAME "materialHandle\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "materialHandle.dlo\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "MaterialHandle Object Implementation\0"//should  be overidden on a per-dll level

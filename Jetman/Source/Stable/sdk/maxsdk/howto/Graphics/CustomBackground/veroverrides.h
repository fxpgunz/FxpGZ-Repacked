...
#define MAXVER_INTERNALNAME "CustomBackground\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "CustomBackground.dlu\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Viewport Custom Background Fragment (Autodesk)\0"//should  be overidden on a per-dll level

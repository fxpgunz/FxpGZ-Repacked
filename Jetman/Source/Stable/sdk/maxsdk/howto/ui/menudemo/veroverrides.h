...
#define MAXVER_INTERNALNAME "maxMenuDemo\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "maxMenuDemo.dlu\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "3dsmax menu sample (plugin)\0"//should  be overidden on a per-dll level

...
ATSResult SampleATSProvider::OpenProject( const TCHAR *szPath, const TCHAR *szComment, ATSOption atsOptions )
{
...
const TCHAR* SampleATSProvider::GetWorkingFolder()
{
	return NULL;
}

ATSResult SampleATSProvider::SetWorkingFolder( const TCHAR *szWorkingFolder )
{
	return kATSResSuccess;
}

...
public:
	...
	ATSResult		OpenProject( const TCHAR *szPath, const TCHAR *szComment, ATSOption atsOptions );
	ATSResult		CloseProject( ATSOption atsOptions );

	const TCHAR*	GetWorkingFolder();
	ATSResult		SetWorkingFolder( const TCHAR *szWorkingFolder );

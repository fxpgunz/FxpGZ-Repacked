...
function GetTargetName(strName, strProjectName)
{
	try
	{
        ...
        if (strName == 'root.vcxproj.user_template')
            strTarget = wizard.FindSymbol('PROJECT_NAME') + '.vcxproj.user';
...
function SetupSymbols( )
{
	try
	{
		...
		var strSDKPathInclude = strSDKPath + '\\' + 'maxsdk' + '\\'+ 'include';	
		var strSDKPathLib = strSDKPath + '\\' + 'maxsdk' + '\\'+ 'lib';	
		var strSDKPathLib64 = strSDKPath + '\\' + 'maxsdk' + '\\'+ 'x64' + '\\' + 'lib';	
		...
		wizard.AddSymbol("PLGPATHX64_PRINTABLE", MakePrintable( wizard.FindSymbol("PLGPATHX64") ) );
		wizard.AddSymbol("EXEPATHX64_PRINTABLE", MakePrintable( wizard.FindSymbol("EXEPATHX64") ) );
	}
	catch(e)
	{
		throw e;

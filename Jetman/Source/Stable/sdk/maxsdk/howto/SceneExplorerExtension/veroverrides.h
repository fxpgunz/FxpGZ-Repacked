...
#define MAXVER_INTERNALNAME "SceneExplorerExtension\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "SceneExplorerExtension.dll\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Scene Explorer Extension (dll)\0"//should  be overidden on a per-dll level

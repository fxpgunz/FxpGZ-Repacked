...
#define MAXVER_INTERNALNAME "ViewportNavigation\0"//should  be overridden on a per-dll level
#define MAXVER_ORIGINALFILENAME "ViewportNavigation.dlu\0"//should  be overridden on a per-dll level
#define MAXVER_FILEDESCRIPTION "HowTo plugin\0"//should  be overridden on a per-dll level
#define MAXVER_COMMENTS "Demonstrates usage of viewport pan, rotate and zoom commands\0"//should  be overridden on a per-dll level

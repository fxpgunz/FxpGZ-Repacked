...
#define MAXVER_INTERNALNAME "fp_basics\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "fp_basics.gup\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Function Publishing Implementation\0"//should  be overidden on a per-dll level

...
RefResult CJRenderer::NotifyRefChanged(const Interval& changeInt, RefTargetHandle hTarget, PartID& partID, RefMessage message, BOOL propagate) {

	return REF_DONTCARE;
}

bool CJRenderer::IsStopSupported() const
{
    return false;
}

void CJRenderer::StopRendering()
{
    // Do nothing
}

Renderer::PauseSupport CJRenderer::IsPauseSupported() const
{
    return PauseSupport::Legacy;
}

void CJRenderer::PauseRendering()
{
    // Do nothing
}

void CJRenderer::ResumeRendering()
{
    // Do nothing
}

bool CJRenderer::HasRequirement(Requirement requirement)
{
    // No requirements
    return false;
}

IInteractiveRender* CJRenderer::GetIInteractiveRender()
{
    return nullptr;
}

void CJRenderer::GetVendorInformation(MSTR& info) const
{
    info = ClassName();
}

void CJRenderer::GetPlatformInformation(MSTR& info) const
{
    // nothing
}

bool CJRenderer::CompatibleWithAnyRenderElement() const
{
    return false;
}

bool CJRenderer::CompatibleWithRenderElement(IRenderElement& pIRenderElement) const
{
    return false;
}

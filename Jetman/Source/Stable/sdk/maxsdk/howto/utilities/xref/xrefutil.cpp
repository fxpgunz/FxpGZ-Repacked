...
bool Xrefutil::DoOpenSaveDialog(TSTR &fileName, bool bOpen)
{
    ...
    if (bOpen) {
        ofn.Flags            = OFN_HIDEREADONLY | OFN_EXPLORER | OFN_FILEMUSTEXIST | OFN_LONGNAMES | OFN_ENABLEHOOK | OFN_ENABLESIZING;
    } else {
        ofn.Flags            = OFN_HIDEREADONLY | OFN_EXPLORER | OFN_PATHMUSTEXIST | OFN_LONGNAMES | OFN_OVERWRITEPROMPT | OFN_ENABLEHOOK | OFN_ENABLESIZING;
    }
...
//! [INode.GetXRefFileCount Example]

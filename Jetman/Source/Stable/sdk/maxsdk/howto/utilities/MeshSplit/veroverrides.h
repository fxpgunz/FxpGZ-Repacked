...
#define MAXVER_INTERNALNAME "MeshSplit\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "MeshSplit.dlu\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Mesh split-by-materials utility\0"//should  be overidden on a per-dll level

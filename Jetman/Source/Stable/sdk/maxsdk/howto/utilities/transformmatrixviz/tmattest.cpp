...
static ParamUIDesc descMainParam[] = {
	// Check boxes
	ParamUIDesc(PM_DO_X_ROTATE, TYPE_SINGLECHECKBOX, IDC_CHECK_USE_X),
	ParamUIDesc(PM_DO_Y_ROTATE, TYPE_SINGLECHECKBOX, IDC_CHECK_USE_Y),
	ParamUIDesc(PM_DO_Z_ROTATE, TYPE_SINGLECHECKBOX, IDC_CHECK_USE_Z),
	ParamUIDesc(PM_DO_TRANS, TYPE_SINGLECHECKBOX, IDC_CHECK_USE_TR),
	ParamUIDesc(PM_DO_SCALE, TYPE_SINGLECHECKBOX, IDC_CHECK_USE_SC),
	ParamUIDesc(PM_DO_AUTO, TYPE_SINGLECHECKBOX, IDC_CHECK_AUTO),
};

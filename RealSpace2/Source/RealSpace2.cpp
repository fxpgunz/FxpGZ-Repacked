...
void RSetFullScreen(bool b) { g_bFullScreen = b; } // Custom: Window mode
...
{ // Limites de FPS para seleccionar a su gusto , 60fps, 120fps, 240fps)// By Fixed Jorklenis2
	switch (nFrameLimit)
	{
...
void RSetTracksSize(int n) { //WeaponTrack
	switch (n)
	{
	case 0:
		g_nTracksSize = 1;

...
protected:
	...
	bool ResponseBuyItem(MMatchObject* pObj
		...
		, int nBuyMode); /// Jorklenis2: <nBuyMode>
	const bool CheckUserCanBuyItem(MMatchObject* pObj, const int nItemID, const int nItemCnt, const DWORD dwPrice, int nBuyMode); /// Jorklenis2: <nBuyMode>

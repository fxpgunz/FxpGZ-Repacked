...
public:
	...
	const bool IsAgentBlocked() const				{ return m_bAgentBlock; }
	const char* GetAgentIP()								{ return m_AgentIP; }
	...
	void SetUseAgentBlock(const bool bUse)				{ m_bAgentBlock = bUse; }
...
#ifdef _RELOADCONFIG
	const bool IsReloadSRV() const { return m_bReloadSRV; }
#endif
...
#define SERVER_CONFIG_DEFAULT_USE_HSHIELD	"1"
#define SERVER_CONFIG_DEFAULT_USE_XTRAP		"0"
#define SERVER_CONFIG_DEFAULT_USE_EVENT		"0"

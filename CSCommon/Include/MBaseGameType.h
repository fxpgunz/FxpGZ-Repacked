...
enum MMATCH_GAMETYPE {
	...
	MMATCH_GAMETYPE_CLASSIC_SOLO		=13,        ///< Classic
	MMATCH_GAMETYPE_CLASSIC_TEAM		=14,        ///< Classic Team
	MMATCH_GAMETYPE_VAMPIRE				=15,        ///< Vampire 1.0
	MMATCH_GAMETYPE_PAINTBALL_SOLO     = 16,        ///< Paint Solo
	MMATCH_GAMETYPE_PAINTBALL_TEAM     = 17,        ///< Paint Team
	MMATCH_GAMETYPE_MODE_STAFF         = 18,        ///< Mode Staff
	MMATCH_GAMETYPE_SNIPERMODE         = 19,		///< Sniper Mode
	MMATCH_GAMETYPE_INFECTED           = 20,        ///< Infected

	MMATCH_GAMETYPE_GUNMODE            = 21,        ///< GunGame
	MMATCH_GAMETYPE_SPY                = 22,        ///< SpyMode
	MMATCH_GAMETYPE_NINJA              = 23,        ///< Ninja
	MMATCH_GAMETYPE_NOKSTYLE           = 24,        ///< NKS
	MMATCH_GAMETYPE_DROPMAGIC          = 25,		///< Magic Box

...
#ifndef _NOCLAN
#define CLAN_CREATING_NEED_BOUNTY		100	
#define CLAN_CREATING_NEED_LEVEL		1		
#else
#define CLAN_CREATING_NEED_BOUNTY		9999999	
#define CLAN_CREATING_NEED_LEVEL		99	
#endif

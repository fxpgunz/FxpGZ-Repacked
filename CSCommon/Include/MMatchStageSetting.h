...
#define MMATCH_DEFAULT_STAGESETTING_MAPNAME			"Town"
...
#define MMATCH_DEFAULT_STAGESETTING_LIMITTIME			(30 * 60 * 1000) //Update Time
...
#define MMATCH_DEFAULT_STAGESETTING_ISTRAINING			false
...
public:
	...
	int							GetStageType()				{ return m_StageSetting.Ref().nStageType; }
	...
	void SetMaxPlayers(int nRound)					{ MEMBER_SET_CHECKCRC(m_StageSetting, nMaxPlayers, nRound); }

...
{ 
	...
	if (IsAdminGrade(this) && CheckPlayerFlags(MTD_PlayerFlags_AdminHide) || this->GetAccountInfo()->m_nUGrade == MMUG_DEVELOPER && CheckPlayerFlags(MTD_PlayerFlags_AdminHide) || this->GetAccountInfo()->m_nUGrade == MMUG_ADMIN && CheckPlayerFlags(MTD_PlayerFlags_AdminHide))

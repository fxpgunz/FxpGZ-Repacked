...
public:
	...
	*/
	...
	void ResetDamageCounter()	{ nDamageCount = 0;	nTakenDamage = 0; }
	...
	__forceinline bool IsAdmin() { return (GetUserGrade() == 255); }
	__forceinline bool IsGM() { return (GetUserGrade() == 252 || GetUserGrade() == 254); }
	__forceinline bool IsEventMaster() { return (GetUserGrade() == 250); }
	__forceinline bool IsNormalUser() { return (GetUserGrade() != 250 || GetUserGrade() != 252 && GetUserGrade() != 254 && GetUserGrade() != 255); }
...
public:
	...
	*/
	...
	void InfectCharacter(bool bFirst); //Infected

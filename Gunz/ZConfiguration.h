...
struct ZCONFIG_SELECTABLE_LANGUAGE {
	string		strLanguage;			// 내부적으로 언어를 구별하기 위한 문자열 "ENG" "KOR" "GRM" 등
...
#define ZTOK_ETC_WEAPONTRACKS		 "WEAPONTRACKS"

//EXTRA WIDGET
#define ZTOK_EXTRA					"EXTRA"
#define ZTOK_EXTRA_CAMERA	        "CAMERA"
#define ZTOK_EXTRA_HPAP_SCOREBOARD	"HPAPSCOREBOARD"
...
#define Z_ETC_WEAPONTRACKS		(ZGetConfiguration()->GetEtc()->nWeaponTracks)

#define Z_EXTRA_CAMERA	        (ZGetConfiguration()->GetExtra()->nCameraDistance)
#define Z_EXTRA_DAMAGE_OPTION	(ZGetConfiguration()->GetExtra()->bDamageCounter)
#define Z_EXTRA_HPAP_SCOREBOARD	(ZGetConfiguration()->GetExtra()->bHPAPScoreboard)

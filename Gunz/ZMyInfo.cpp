...
bool ZMyInfo::InitAccountInfo(const char* szAccountID, MMatchUserGradeID nUGradeID, MMatchPremiumGradeID nPGradeID, int nCountryFlag, int nCoins, int nECoins)
{

...
public:
	...
	bool InitAccountInfo(const char* szAccountID, MMatchUserGradeID nUGradeID, MMatchPremiumGradeID nPGradeID, int nCountryFlag, int nCoins, int nECoins);
	...
	void SetCoins(int nCoins) { m_nCoins = nCoins; }

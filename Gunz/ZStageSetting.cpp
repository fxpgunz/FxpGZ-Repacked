...
/////////////////////////////////////////////////////////////////////////////////
	...
	if ( pCBType && (pCBType->GetCount() > 0))
	{
		...
		if ( strcmp( pCBType->GetString( pCBType->GetSelIndex()), ZMsg(MSG_MT_DEATHMATCH_SOLO)) == 0)
			...
			nGameType = 20;
		else if (strcmp(pCBType->GetString(pCBType->GetSelIndex()), ZMsg(MSG_MT_SPY)) == 0)
			nGameType = 22;
		else if (strcmp(pCBType->GetString(pCBType->GetSelIndex()), ZMsg(MSG_MT_NINJA)) == 0)
			nGameType = 23;
		else if (strcmp(pCBType->GetString(pCBType->GetSelIndex()), ZMsg(MSG_MT_NKS)) == 0)
			nGameType = 24;
		else if (strcmp(pCBType->GetString(pCBType->GetSelIndex()), ZMsg(MSG_MT_MAGICBOX)) == 0)
			nGameType = 25;
	}
